...
//#endif
    ...
    IMGUI_API void          RenderFrameWithGradient(ImVec2 p_min, ImVec2 p_max, ImU32 up_left_col, ImU32 up_right_col, ImU32 bottom_right_col, ImU32 bottom_left_col, bool border = true);
